...
`vendor_reuse/` directory, while Toche implements its own integration under `src/`.
Applicable licenses, copyright notices, project links, and integration decisions
are preserved here.
